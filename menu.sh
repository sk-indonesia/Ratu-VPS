...
echo -e "${CYAN}║${NC} [${ORANGE}03${NC}] ${BLUE}VLESS MENU${NC}      ${CYAN}│${NC} [${ORANGE}10${NC}] ${BLUE}INFO PORT${NC}       ${CYAN}│${NC} [${ORANGE}18${NC}] ${BLUE}RESTART${NC}        ${CYAN}║${NC}"
...
printf "${CYAN}║${NC} %-15s = ${LIGHT_CYAN}%-43s${CYAN}║\n" "User" "RatuSTORE"
printf "${CYAN}║${NC} %-15s = ${GREEN}%-43s${CYAN}║\n" "Script Status" "Active"
